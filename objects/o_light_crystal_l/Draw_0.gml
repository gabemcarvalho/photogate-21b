...
shader_set_uniform_f(uni_brighten_amount,bright_amount);
	...
	if shining draw_sprite(s_light_crystal_shine_l,shine_image,x,y);
shader_reset();
...
if photon_in {
	...
	surface_set_target(o_controller.surf_gui);
		switch in_timer {
			case 0: draw_sprite(s_light_crystal_dir_ind_l,dir_tot,x,y); break;
			case 1: draw_sprite(s_light_crystal_dir_ind_l,0,x,y); break;
		}
}
